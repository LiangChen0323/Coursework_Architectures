...
namespace Platformer
{
	...
	class Player 
	{
		...
		public void LoadContent()
		{
			...
			idleAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/Idle"), 0.05f, true);
        ...
        public void RunLeft(eButtonState buttonState, Vector2 amount)
        {
        ...
        public void RunRight(eButtonState buttonState, Vector2 amount)
        {
            if(buttonState == eButtonState.DOWN)
            {
                movement = 1.0f;
